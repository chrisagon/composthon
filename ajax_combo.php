...
*/
	...
	$lookups = array(   
		'Compostage' => array(   
			'lieu_compostage' => array(
				'parent_table' => 'Sites',
				'parent_pk_field' => 'id',
				'parent_caption' => '`Sites`.`nom`',
				'parent_from' => '`Sites` ',
				'filterers' => array(),
				'custom_query' => '',
			...
			'matiere' => array(
				'parent_table' => 'matieres',
				'parent_pk_field' => 'id',
				'parent_caption' => '`matieres`.`nom`',
				'parent_from' => '`matieres` ',
				'filterers' => array(),
				'custom_query' => '',
				'inherit_permissions' => false,
				'list_type' => 0,
		...
		'Demande' => array(   
			'site_compostage' => array(
				...
				'parent_from' => '`Sites` ',
				'filterers' => array(),
				'custom_query' => 'SELECT `Sites`.`id`, `Sites`.`nom` FROM `Sites` WHERE `Sites`.`type` = \'Compostage\' ORDER BY 2',
				'inherit_permissions' => false,
				'list_type' => 0,
				'not_null' => false
			),
