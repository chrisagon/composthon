<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'feedback' table. 
	...
	*/
	...
	function feedback_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function feedback_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function feedback_footer($contentType, $memberInfo, &$args){
		$footer='';
	 ...
	 *     $data['titre'], $data['fonctionnalite'], $data['description'], $data['plus'], $data['moins'], $data['kanban'], $data['commentaires']
	...
	*/
	...
	function feedback_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function feedback_after_insert($data, $memberInfo, &$args){
	...
	*/
	...
	function feedback_before_update(&$data, $memberInfo, &$args){
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['id'], $data['titre'], $data['fonctionnalite'], $data['description'], $data['plus'], $data['moins'], $data['kanban'], $data['commentaires']
	...
	*/
	...
	function feedback_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function feedback_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function feedback_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function feedback_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function feedback_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function feedback_batch_actions(&$args){
