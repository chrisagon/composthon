<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'matieres' table. 
	...
	*/
	...
	function matieres_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function matieres_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function matieres_footer($contentType, $memberInfo, &$args){
		$footer='';
	 ...
	 *     $data['nom'], $data['type'], $data['description']
	...
	*/
	...
	function matieres_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function matieres_after_insert($data, $memberInfo, &$args){
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['nom'], $data['type'], $data['description']
	...
	*/
	...
	function matieres_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function matieres_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function matieres_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function matieres_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function matieres_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function matieres_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function matieres_batch_actions(&$args){
