<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'Compostage' table. 
	...
	*/
	...
	function Compostage_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function Compostage_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function Compostage_footer($contentType, $memberInfo, &$args){
		$footer='';
	 ...
	 *     $data['date'], $data['lieu_compostage'], $data['matiere'], $data['poids']
	...
	*/
	...
	function Compostage_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function Compostage_after_insert($data, $memberInfo, &$args){
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['date'], $data['lieu_compostage'], $data['matiere'], $data['poids']
	...
	*/
	...
	function Compostage_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function Compostage_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function Compostage_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function Compostage_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function Compostage_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function Compostage_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function Compostage_batch_actions(&$args){
