<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'linkpage' table. 
	...
	*/
	...
	function linkpage_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function linkpage_header($contentType, $memberInfo, &$args){
		$header='';
...
<style>footer {display:none;}</style> 
	...
	*/
	...
	function linkpage_footer($contentType, $memberInfo, &$args){
		$footer='';
	...
	*/
	...
	function linkpage_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function linkpage_after_insert($data, $memberInfo, &$args){
	...
	*/
	...
	function linkpage_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function linkpage_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function linkpage_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function linkpage_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function linkpage_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function linkpage_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function linkpage_batch_actions(&$args){
