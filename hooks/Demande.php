<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'Demande' table. 
	...
	*/
	...
	function Demande_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function Demande_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function Demande_footer($contentType, $memberInfo, &$args){
		$footer='';
	 ...
	 *     $data['type'], $data['site_compostage'], $data['site_dechet'], $data['desc'], $data['date_lancement'], $data['date_butoir'], $data['date_inter'], $data['intervenant'], $data['prix_unit'], $data['niveau'], $data['etat']
	...
	*/
	...
	function Demande_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function Demande_after_insert($data, $memberInfo, &$args){
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['type'], $data['site_compostage'], $data['site_dechet'], $data['desc'], $data['date_lancement'], $data['date_butoir'], $data['date_inter'], $data['intervenant'], $data['prix_unit'], $data['niveau'], $data['etat']
	...
	*/
	...
	function Demande_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function Demande_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function Demande_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function Demande_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function Demande_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function Demande_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function Demande_batch_actions(&$args){
