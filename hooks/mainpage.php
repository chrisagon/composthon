<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'mainpage' table. 
	...
	*/
	...
	function mainpage_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function mainpage_header($contentType, $memberInfo, &$args){
		$header='';
...
<style>footer {display:none;}</style> 
	...
	*/
	...
	function mainpage_footer($contentType, $memberInfo, &$args){
		$footer='';
	...
	*/
	...
	function mainpage_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function mainpage_after_insert($data, $memberInfo, &$args){
	...
	*/
	...
	function mainpage_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function mainpage_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function mainpage_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function mainpage_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function mainpage_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function mainpage_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function mainpage_batch_actions(&$args){
