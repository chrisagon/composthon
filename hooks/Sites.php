<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'Sites' table. 
	...
	*/
	...
	function Sites_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function Sites_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function Sites_footer($contentType, $memberInfo, &$args){
		$footer='';
	 ...
	 *     $data['type'], $data['nom'], $data['adress'], $data['nbr']
	...
	*/
	...
	function Sites_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function Sites_after_insert($data, $memberInfo, &$args){
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['type'], $data['nom'], $data['adress'], $data['nbr']
	...
	*/
	...
	function Sites_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function Sites_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function Sites_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function Sites_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function Sites_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function Sites_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function Sites_batch_actions(&$args){
